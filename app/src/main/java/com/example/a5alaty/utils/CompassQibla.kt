...
import com.example.a5alaty.model.local.QiblaDirection
import com.example.a5alaty.utils.LocationUtils.checkLocationPermission
import com.example.a5alaty.viewmodel.CompassQiblaViewModel
...
class CompassQibla {
    ...
    class Builder(private val activity: AppCompatActivity) : SensorEventListener {
        ...
        fun onGetLocationAddress(onGetLocation: (address: Address) -> Unit) = apply {
            model.locationAddress.observe(activity) {
                onGetLocation(it)
            }
        }
